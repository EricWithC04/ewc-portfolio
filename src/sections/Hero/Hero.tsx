...
export const Hero = ({ isExiting, isStarting, exitingAnimations }: { isExiting: boolean, isStarting: boolean, exitingAnimations: Animations }) => {
    ...
    return (
        <motion.section
            initial={isStarting ? false : { backgroundColor: "#fff" }}
            animate={isStarting ? false : { backgroundColor: "#000" }}
            transition={isStarting ? {} : { duration: 0.8 }}
        ...
        >
            ...
            <div className='relative z-10 pt-32 pb-16'>
                <div className="h-[100%] grid lg:grid-cols-2">
                    <motion.div
                        key={pathname}
                        initial={isStarting ? false : { opacity: 0, x: -50 }}
                        animate={isStarting ? false : { opacity: 1, x: 0 }}
                        transition={isStarting ? {} : { duration: 0.8, delay: 1.2 }}
                    >
                    ...
                    <motion.div
                        initial={isStarting ? false : { opacity: 0, x: 50 }}
                        animate={isStarting ? false : { opacity: 1, x: 0 }}
                        transition={isStarting ? {} : { duration: 0.8, delay: 1.3 }}
                    >
                        <div className='relative h-full w-full flex items-center justify-center pt-16'>
                            ...
                            ></motion.div>
                            <div 
                                className='relative flex items-center justify-center h-96 w-96 rotate-45 rounded-3xl overflow-hidden'
                            >
                                <Image 
                                    ...
                                    height={600} 
                                />
                                {!isStarting && images.map((image, index) => (
                                    <motion.div
                                        key={index}
