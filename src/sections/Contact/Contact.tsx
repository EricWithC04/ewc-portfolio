...
export const Contact = () => {
    ...
    return (
        <section className='bg-black py-24 space-y-8'>
                    ...
                    <div>
                        ...
                        <div className='flex flex-col gap-2'>
                            {contactInfo.map((item, index) => (
                                <div key={index} className='relative group flex items-center p-2 gap-2 rounded-lg overflow-hidden hover:cursor-pointer'>
