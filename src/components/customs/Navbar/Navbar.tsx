...
export const Navbar = ({ isExiting, isStarting }: { isExiting: boolean, isStarting: boolean }) => {
    ...
    return (
        <motion.nav 
            ...
            transition={{ duration: isStarting ? 0.8 : 1, delay: isStarting ? 0.2 : isExiting ? 0.2 : 0.5 }}
